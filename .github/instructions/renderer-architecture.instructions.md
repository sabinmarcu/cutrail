...
2. Related windows may share a folder when they belong to the same flow.
- Example: update-related dialogs may live under `src/renderer/windows/updates`.

3. Place components shared across multiple windows under:
- `src/renderer/components`

4. Window-local component exception:
...
5. Child component naming for single-master usage:
- Pattern: `MasterComponent.ChildComponent.tsx`

6. Shared UI behavior must be componentized.
...
7. Keep window responsibilities explicit.
...
8. Shared utility components must use shared component paths.
...
- Component files and component names should use CamelCase.

9. Editor-local timeline modules must stay editor-local.
...
10. Clipping logic belongs in renderer core context modules.
...
11. Use grouped core module naming and barrels.
...
12. Editor windows are multi-instance per source video.
...
13. Keyboard shortcut parity rule.
