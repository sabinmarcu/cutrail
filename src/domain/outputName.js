...
export const normalizeClipSourceName = (sourcePath) => sanitizeSegment(path.parse(sourcePath).name || 'clip');
...
export const parseClipTimestamp = (value) => {
...
export const parseClipOutputName = (fileName) => {
  ...
  return {
    ...
    trimMode: match.groups.trimMode,
    range: {
      start,
      end,
      duration: end - start,
