...
globalStyle(`${runtimeMarkdown} :is(h1, h2, h3, h4)`, {
  color: theme.colors.primary.base,
...
globalStyle(`${runtimeMarkdown} ul, ${runtimeMarkdown} ol`, {
  color: theme.colors.secondary.emphasis,
  marginBlock: `${theme.grid.xs}`,
  paddingInlineStart: '1.2rem',
});

globalStyle(`${runtimeMarkdown} li`, {
  marginBlock: `${theme.grid.xs}`,
});

globalStyle(`${runtimeMarkdown} code`, {
  color: theme.colors.primary.emphasis,
  fontFamily: 'monospace',
});

globalStyle(`${runtimeMarkdown} a`, {
  color: theme.colors.primary.base,
});

globalStyle(`${runtimeMarkdown} pre`, {
  margin: 0,
  whiteSpace: 'pre-wrap',
});
